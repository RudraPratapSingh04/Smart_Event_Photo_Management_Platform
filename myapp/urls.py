...
urlpatterns = [
    ...
    path('api/user_uploaded_photos/',views.user_uploaded_photos,name='user_uploaded_photos'),
    ...
    path('api/search_event_photos/<str:event_slug>/',views.search_event_photos,name='search_event_photos'),
